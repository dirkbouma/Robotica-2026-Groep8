...
DIR_TX = False  # True usually means HIGH
DIR_RX = True #usually means LOW
...
if DIR_PIN is not None:
    try:
        ...
        dir_output.value = DIR_TX # Start in RX mode
    except ImportError:
...
class AX12A_Debug(cmd.Cmd):
    ...
    def set_tx_mode(self):
        ...
        if dir_output is not None:
            dir_output.value = DIR_TX # DIR_TX
    ...
    def set_rx_mode(self):
        ...
        if dir_output is not None:
            dir_output.value = DIR_RX # DIR_RX
